...
% Modified by Chen Zhiyuan (chenzhiyuan0920@gmail.com) to fit the need of ZJNU students.


\documentclass[12pt]{ZJNUletter}
\usepackage{fontspec} 
\usepackage{tikz} 
\usepackage{xcolor}
	\definecolor{zjnugreen}{RGB}{1, 110, 52}
\usepackage{lipsum}
\usepackage{fancyhdr}
\usepackage{lastpage}
\usepackage{eso-pic}
...
\def\name{xxx,\\
Professor,\\
College of Mathematics and Computer Science, ZJNU
}
%
...
\def\Where{\hspace{-1.2mm}\textbf{\color{zjnugreen}%{zjnugreen}
...
\def\Address{No.688, Yingbin RD\\
Wucheng District,} 
%
\def\CityZip{Jinhua, 321004} 
%
% Set your Zjnu e-mail here
\def\Email{\textbf{\color{zjnugreen}E-mail}: xxx@zjnu.edu.cn}
%
% Set your preferred contact number here
\def\TEL{\textbf{\color{zjnugreen}Phone}: 310-555-5555}
%
% Set your department or personal website here
\def\URL{\textbf{\color{zjnugreen}URL}: http://www.zjnu.edu.cn/}
%
%%%%%%%%%%%%%%%%  Footer information  %%%%%%%%%%%%%%%%%%
%
...
\def\school{\small{
  ZJNU $\cdot$
     ~College of Mathematics and Computer Science $\cdot$
     ~No.688 Yingbin RD $\cdot$
     ~Jinhua, China P.R} } 
